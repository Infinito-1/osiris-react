  ...
  return (
    <div className="bg-white border border-gray-300 rounded-lg p-6 shadow-md h-full flex flex-col">
      ...
      <div className="flex flex-col space-y-2">
        ...
        <Link to={`/projeto/${id}`}>
          <button className="cursor-pointer btn-detalhes w-full bg-gray-200 text-gray-800 py-2 px-4 rounded-md text-base font-medium transition-colors duration-200 hover:bg-gray-300 shadow-md">
            Ver Detalhes
          </button>
        </Link>
      </div>
