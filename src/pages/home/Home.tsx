        ...
        <section id="como-funciona" className="text-center py-5">
            ...
            <div className="mx-[10%] my-10">
                ...
                <div className="flex gap-15 justify-center">
                    <div className="justify-center w-[25%] p-2 hover:scale-110 transition-transform duration-200">
                    ...
                    <div className="justify-center w-[25%] hover:scale-110 transition-transform duration-200">
